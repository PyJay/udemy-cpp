/*
In this exercise you will create a program that will be used to print the guest_list to an event
and then clear the guest_list when the event is over.

Begin by completing the function prototypes print_guest_list and clear_guest_list 
which are both passed an array of std::string and a size_t value.
...
Both the print_guest_list and clear_guest_list functions will be passed the array argument guest_list and the size_t argument
guest_list_size which have both been provided to you.

The print_guest_list function should print the values contained within the guest_list from left to right with each element being printed on a new line.
